...
////delete is use to delete the delete element in the list but position of deleted item will not be affected , so the length of the array is same
let num1 = [1, 2, 3]
...
console.log(num5) //[ 55, 32, 44, 77, 200 ]
num5.sort()
